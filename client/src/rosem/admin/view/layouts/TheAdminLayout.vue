...
<style lang="postcss" scoped>
    .TheAdminLayout {
        display: grid;
        grid-template: "header header header" auto "navigation content sidebar" 1fr "footer footer footer" auto /
            1fr 2fr 1fr;
        min-height: 100%;
...
<style lang="postcss">
    .TheAdminLayout-fade-enter-active, .TheAdminLayout-fade-leave-active {
        & > nav, & > section > *, & > aside {
    ...
    .TheAdminLayout-fade-enter, .TheAdminLayout-fade-leave-to {
        position: absolute;
