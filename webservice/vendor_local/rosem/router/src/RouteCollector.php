...
class RouteCollector implements RouteCollectorInterface
{
    ...
    {
        $this->addRoute(self::METHOD_GET, $route, $handler);
    }
    ...
    {
        $this->addRoute(self::METHOD_PUT, $route, $handler);
    }
    ...
    {
        $this->addRoute(self::METHOD_DELETE, $route, $handler);
    }
    ...
    {
        $this->addRoute(self::METHOD_PATCH, $route, $handler);
    }
    ...
    {
        $this->addRoute(self::METHOD_HEAD, $route, $handler);
    }
